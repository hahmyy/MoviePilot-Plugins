...
| 插件 ID | 版本线 | 说明 |
|---|---|---|
| AppPushMsg | V2 兼容 0.1.3（plugins/ 与 plugins.v2/ 双份）/ V3 1.0.3 | 把 MoviePilot 通知推送到鸿蒙/Android/iOS（系统级推送，极光 JPush v3）；插件详情页展示最近一次测试结果；首页仪表盘展示调用次数、连接状态与历史消息；支持按消息类型筛选转发 |
